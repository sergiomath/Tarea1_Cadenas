...
\newcommand{\templatePagecfg}{%
	...
	% -------------------------------------------------------------------------
	% Fondo de página con degradado
	% -------------------------------------------------------------------------
	\AddToShipoutPictureBG{%
		\AtPageLowerLeft{%
			\begin{tikzpicture}[remember picture,overlay]
				% Inserta la imagen con opacidad al 5% y tamaño al 60% (solo después de portada)
				\ifnum\value{page}>1
					\node[anchor=center,opacity=0.05,inner sep=0pt] at (current page.center) {%
						\includegraphics[width=0.6\paperwidth,keepaspectratio]{img/Logotipounal2.png}%
					};
				\fi
				% Capa de degradado blanco desde los bordes
				\shade[left color=white,right color=white!0,middle color=white!10]
					(0,0) rectangle (3cm,\paperheight);
				\shade[right color=white,left color=white!0,middle color=white!10]
					(\paperwidth-3cm,0) rectangle (\paperwidth,\paperheight);
				\shade[top color=white,bottom color=white!0,middle color=white!10]
					(0,\paperheight-3cm) rectangle (\paperwidth,\paperheight);
				\shade[bottom color=white,top color=white!0,middle color=white!10]
					(0,0) rectangle (\paperwidth,3cm);
			\end{tikzpicture}%
		}%
	}
