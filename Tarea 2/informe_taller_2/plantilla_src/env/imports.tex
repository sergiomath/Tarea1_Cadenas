...
%\usepackage{physics}       % Paquete de matemáticas (comentado - no disponible)
...
\usepackage{eso-pic}       % Permite agregar imágenes de fondo en páginas
\usepackage{tikz}          % Permite crear gráficos y efectos
...
%\usepackage{commonunicode} % Símbolos unicode (comentado - requiere stmaryrd)
